        ...
        <div className="store-container">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center gap-1 md:gap-3">
              ...
              <Link
                to="/oenskeliste"
                className="relative p-2 text-blush hover:text-blush-foreground transition-colors hidden md:block"
                aria-label="Ønskeliste"
              >
                <Heart size={20} />
                {wishlistCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 w-5 h-5 bg-blush text-blush-foreground text-[10px] font-semibold rounded-full flex items-center justify-center">
                    {wishlistCount}
                  </span>
                )}
              </Link>
          ...
          <div className="md:hidden border-t border-border bg-background animate-fade-in">
            <nav className="store-container py-4 space-y-1">
              ...
              <div className="pt-4 border-t border-border mt-4">
                <Link
                  to="/oenskeliste"
                  className="flex items-center gap-3 py-3 text-base font-medium text-blush"
                >
                  <Heart size={18} />
                  Ønskeliste
                </Link>
