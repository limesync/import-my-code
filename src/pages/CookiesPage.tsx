        ...
        <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
          <section>
            ...
            <p>
              ...
              telefon, når du besøger vores hjemmeside. Cookies hjælper os med at 
              genkende dig og huske dine præferencer.
            </p>
          </section>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  <tr className="border-b">
                    ...
                    <td className="py-3 pr-4">Gemmer dit cookiesamtykke</td>
                    <td className="py-3">1 år</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-3 pr-4">session</td>
                    <td className="py-3 pr-4">Nødvendig</td>
                    <td className="py-3 pr-4">Holder dig logget ind</td>
                    <td className="py-3">Session</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-3 pr-4">cart</td>
                    <td className="py-3 pr-4">Nødvendig</td>
                    <td className="py-3 pr-4">Husker din indkøbskurv</td>
                    <td className="py-3">30 dage</td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-3 pr-4">_ga</td>
                    <td className="py-3 pr-4">Statistik</td>
                    <td className="py-3 pr-4">Google Analytics - besøgsstatistik</td>
          ...
          <section>
            ...
            <p>
              ...
              på "Cookieindstillinger" i bunden af siden. Du kan også slette 
              cookies i din browser.
            </p>
            <p>
              Bemærk, at hvis du deaktiverer nødvendige cookies, kan dele af 
              hjemmesiden ikke fungere korrekt.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Du kan slette cookies via din browsers indstillinger. Processen 
              varierer afhængigt af browser:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              Vi bruger cookies fra betroede tredjeparter som Google Analytics til 
              at analysere trafik på siden. Disse tredjeparter kan placere deres 
              egne cookies. Se deres respektive privatlivspolitikker for mere 
              information.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              mere information om, hvordan vi behandler dine personoplysninger.
            </p>
          </section>
        </div>
      </div>
