      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
          <section>
            ...
            <p>
              Thumbie er dataansvarlig for behandlingen af de personoplysninger, 
              vi indsamler om dig. Har du spørgsmål til vores behandling af dine 
              personoplysninger, er du velkommen til at kontakte os på:
            </p>
            <p>
              Email: hej@thumbie.dk<br />
              Adresse: Designvej 42, 2100 København Ø
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              de formål, de er indsamlet til. Ordreoplysninger opbevares i 5 år 
              af hensyn til bogføringsloven. Marketingsamtykke slettes, når du 
              trækker det tilbage.
            </p>
          </section>
          ...
          <section>
            <h2 className="font-display text-2xl font-semibold text-foreground mb-4">
              7. Deling af oplysninger
            </h2>
            <p>
              Vi deler kun dine oplysninger med betroede partnere, der hjælper os 
              med at drive vores forretning, fx:
            </p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>
              Alle partnere er forpligtet til at beskytte dine data og må kun 
              bruge dem til det aftalte formål.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Vi tager sikkerheden af dine data alvorligt og bruger SSL-kryptering, 
              sikre servere og adgangskontrol for at beskytte dine oplysninger.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Har du spørgsmål til denne privatlivspolitik eller ønsker at udøve 
              dine rettigheder, kan du kontakte os på hej@thumbie.dk.
            </p>
          </section>
        </div>
      </div>
